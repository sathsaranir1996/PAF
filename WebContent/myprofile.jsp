...
<div id="top-bar" class="container">
			...
			<section  class="homepage-slider" id="home-slider">
				<div class="flexslider">
					<ul class="slides">
						...
						<li>
							<img src="themes/images/carousel/img9.jpg" alt="" style="width:1200px;height:500px;">
						</li>
						<li>
			...
			<section class="main-content">
				<!-- Main Content -->
					<div style = "text-align: center;">
						...
						<br/>
						<!-- <a href = "entry/member/deactivate?name=<%=un%>">Deactivate my account</a> -->
						<pre style = "font-family:sans-serif; font-size: 24px; width: 70%; margin-left: 15%">  <a href = "entry/member/generateUpdateForm?name=<%=un%>">Edit My Profile</a>          <button onclick = "myFunction()">Deactivate</a></pre>
					</div>
		...
		<script>
						function myFunction() {
						  var txt;
						  if (confirm("Shall I deactiate your account?")) {
							  location.replace("entry/member/deactivate?name=<%=un%>")
						  } else {
						    alert("Deactivation canceled");
						  }
