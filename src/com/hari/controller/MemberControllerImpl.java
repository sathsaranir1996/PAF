...
public interface MemberControllerImpl {
	...
	Member registerHari(String name, String password, String type, String add, String mail, int cno);
	String registerUser(String name, String password, String type, String add, String mail, int cno);
	String updateUser(String name, String type, String add, String mail, int cno);
}
